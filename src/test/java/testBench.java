...
public class testBench {
    ...
    public static void main (String[] args) throws IOException, InterruptedException {
        ...
        FileOutputStream out = new FileOutputStream("url.properties");
        ...
        for (int i = 1; i <= 615; i++) {
            ...
            for (int l = 1; l <= 20; l++) {
                try {
                    WebElement json = driver.findElement(By.xpath(
                    ...
                    props.setProperty(json.getAttribute("href"), ref.getAttribute("href"));
